"use strict";
(self["webpackChunk_anaconda_core"] = self["webpackChunk_anaconda_core"] || []).push([["lib_core_lib_index_js-_68b21"],{
...
async function getLaunchDarklyClient(config) {
    ...
    try {
        ...
        context = {
            ...
            environment2: config.environment2,
        };
    }
...
class Plugin {
    ...
    async getAccountDetails() {
        return await _anaconda_shared__WEBPACK_IMPORTED_MODULE_0__.backend
            .backendFetch("aext_profile_manager_server/account_details", {}, {})
    ...
    async _getReady() {
        ...
        if (config.environment2 === "local_development" &&
            config.environment === _anaconda_shared__WEBPACK_IMPORTED_MODULE_0__.Environment.local) {
        ...
        try {
            const analytics = {
                heap: config.environment2 !== "local_development"
                    ? await (0,_heap__WEBPACK_IMPORTED_MODULE_3__.initializeHeap)(config, await this.getAccountDetails())
                    : false,
                datadog: config.environment2 !== "local_development"
                    ? (0,_datadog__WEBPACK_IMPORTED_MODULE_4__.initializeDatadog)(config, featureFlag.getBool("monorepo-datadog", false))
                    : false,
            };
            return {
                featureFlag,
...
//# sourceMappingURL=lib_core_lib_index_js-_68b21.785c52e4869cd87ff060.js.map